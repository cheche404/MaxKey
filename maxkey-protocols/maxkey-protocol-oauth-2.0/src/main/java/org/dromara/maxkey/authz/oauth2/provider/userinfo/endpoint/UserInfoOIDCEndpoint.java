...
public class UserInfoOIDCEndpoint {
	...
	@ResponseBody
	public Map connect10aUserInfo(HttpServletRequest request,
		...
		try{
			...
			try {
				// 使用 fastjson 将 userJson 字符串转换为 JSONObject
				jsonObject = JSONObject.parseObject(userJson);
			...
			Map<String,Object>authzException=new HashMap<String,Object>();
...
//	}
	...
	public Map<String,Object> accessTokenFormatError(String access_token){
		Map<String,Object> atfe=new HashMap<String,Object>();
