...
public class OauthJwksEndpoint extends AbstractEndpoint {
	...
	@ResponseBody
	public Map  keysMetadataByParam(HttpServletRequest request , HttpServletResponse response,
	...
	@RequestMapping(value = OAuth2Constants.ENDPOINT.ENDPOINT_BASE + "/{instId}/{clientId}/jwks",
					method={RequestMethod.POST, RequestMethod.GET})
	@ResponseBody
	public Map keysMetadatabyPath(HttpServletRequest request , HttpServletResponse response,
	...
	@RequestMapping(
			...
			method={RequestMethod.POST, RequestMethod.GET})
	@ResponseBody
	public Map metadata(HttpServletRequest request , HttpServletResponse response,
			@PathVariable(value="clientId") String clientId,
...
//	}
	...
	public Map buildMetadata(HttpServletRequest request , HttpServletResponse response,
			String instId,String clientId,String mediaType){
		ClientDetails  clientDetails = null;
		try {
			clientDetails = getClientDetailsService().loadClientByClientId(clientId,true);
		...
		if(clientDetails != null) {
			...
			result.put("message", clientId + " not exist . \n" + WebContext.version());
			return result;
		}
	}
